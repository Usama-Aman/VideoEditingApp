...
public interface OnPhotoEditorListener {
     ...
     * @param viewType enum which define type of view is added
     */
    void onStartViewChangeListener(ViewType viewType, float x, float y);
...
//    void getViewCoordinates(float x, float y, View view, RelativeLayout parentView, ViewType viewType, int majorViewLeft, int majorViewTop);
    void getViewCoordinates(
            float x, float y, View view,
            RelativeLayout parentView, ViewType viewType,
            float percentageOfViewInParentXaxis, float percentageOfViewInParentYaxis,
            float viewCoard_X, float viewCoard_Y
            );
}
